...
public class WebService {
    private final String URL = "http://www.ecxtrack.com:7090/RestService.svc/soap";
    ...
    public Usuario Login (String pNomeUsuario, String pSenha) throws XmlPullParserException, HttpResponseException, SoapFault {
        ...
        SOAP_ACTION = "http://tempuri.org/IRestService/Login";
        METHOD_NAME = "Login";
    ...
    public Evento UltimaLocalizacaoVeiculo (int pCodVeiculo) throws XmlPullParserException, HttpResponseException, SoapFault{
        //CodVeiculo
        SOAP_ACTION = "http://tempuri.org/IRestService/UltimaLocalizacaoVeiculo";
        ...
        try {
            ...
            if (resposta != null)
            {
                ...
                oEvento.setDataEvento(new DateTime(resposta.getPropertyAsString("DataEventoAndroid")));
    ...
    public List<Veiculo> VeiculosPorCliente (int pCodusuario, boolean IsClienteAdicional) throws XmlPullParserException, HttpResponseException, SoapFault {
        //CodVeiculo
        SOAP_ACTION = "http://tempuri.org/IRestService/VeiculosPorCliente";
    ...
    public List<Evento> Trajetos (DateTime pDataInicial, DateTime pDataFinal, int pCodVeiculo)  throws XmlPullParserException, HttpResponseException, SoapFault{
        //CodVeiculo
        SOAP_ACTION = "http://tempuri.org/IRestService/ListaPontosPeriodo";
        METHOD_NAME = "ListaPontosPeriodo";

        //Define Objeto SOAP
        SoapObject soap = new SoapObject(NAMESPACE, METHOD_NAME);
        String dataIni = pDataInicial.toString("dd-MM-YYYY");
        String horaIni = pDataInicial.toString("HH-mm-ss");
        String dataFin = pDataFinal.toString("dd-MM-YYYY");
        String horaFin = pDataFinal.toString("HH-mm-ss");

        soap.addProperty("DataIni", dataIni + "$" + horaIni);
        soap.addProperty("DataFim", dataFin + "$" + horaFin);
        soap.addProperty("CodVeiculo", pCodVeiculo);
        ...
        if (envelope.getResponse() != null) {
            ...
            for (int i = 0; i < result.getPropertyCount(); i++) {
                ...
                oEvento.setDataEvento(new DateTime(object.getPropertyAsString("DataEventoAndroid")));
                vRet.add(oEvento);
            }
        }
        return vRet;
